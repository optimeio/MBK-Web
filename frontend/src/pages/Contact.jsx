            ...
            <div className="contact-main-grid">
                ...
                <div className="reveal">
                    <div className="contact-form-wrap">
                        ...
                        <form id="contact-form" noValidate onSubmit={handleFormSubmit}>
                            ...
                            <button type="submit" className="btn btn-primary" id="form-submit-btn" disabled={formState !== 'idle'}
                                style={{ width: '100%', justifyContent: 'center', padding: '1.05rem', fontSize: '1rem', letterSpacing: '0.3px', background: formState === 'success' ? 'linear-gradient(135deg,#25d366,#128c7e)' : '' }}>
                                {formState === 'idle' && <><Icon name="send" style={{ width: '18px', height: '18px' }} /> Send Message</>}
                                {formState === 'sending' && <><Icon name="loader" style={{ width: '18px', height: '18px', animation: 'spin 1s linear infinite' }} /> Sending...</>}
                                {formState === 'success' && <><Icon name="check" style={{ width: '18px', height: '18px' }} /> Message Sent!</>}
                            </button>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
                    ...
                    <div className="reveal delay-2" style={{ background: 'linear-gradient(135deg,rgba(37,211,102,0.08),rgba(18,140,126,0.08))', border: '1px solid rgba(37,211,102,0.2)', borderRadius: 'var(--radius-md)', padding: '2rem', textAlign: 'center' }}>
                        ...
                        <a href="https://wa.me/918807653965?text=Hello%20MBK%20TECHNOLOGY,%20I%20am%20interested%20in%20your%20programs."
                            target="_blank" rel="noopener noreferrer" className="btn btn-primary"
                            style={{ background: 'linear-gradient(135deg,#25d366,#128c7e)', boxShadow: '0 4px 16px rgba(37,211,102,0.35)', width: '100%', justifyContent: 'center' }}>
                            <Icon name="message-circle" style={{ width: '18px', height: '18px' }} />
                            Open WhatsApp Chat
                        </a>
                    </div>
                </div>
