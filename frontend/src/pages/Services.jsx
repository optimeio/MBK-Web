        ...
        <div className="container" style={{ textAlign: 'center' }}>
            <div className="reveal">
                ...
                <div style={{ display: 'flex', gap: '1.1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
                    <a href="https://wa.me/918807653965?text=Hello%20MBK%20TECHNOLOGY,%20I'm%20interested%20in%20institutional%20partnership."
                        className="btn btn-primary" target="_blank" rel="noopener noreferrer">
                        <Icon name="message-circle" style={{ width: '18px', height: '18px' }} /> Partner with Us
                    </a>
                    <Link to="/contact" className="btn btn-outline">
                        <Icon name="mail" style={{ width: '18px', height: '18px' }} /> Request a Proposal
                    </Link>
                </div>
            </div>
        </div>
