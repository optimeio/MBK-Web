...
function AdminDashboard() {
  ...
  if (!isAuthenticated) {
    return (
      <main style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        <Helmet><title>Admin Login | MBK Technology</title><meta name="robots" content="noindex" /></Helmet>
  ...
  return (
    <main style={{ paddingTop: '100px', minHeight: '80vh' }}>
      <Helmet><title>Admin Dashboard | MBK Technology</title><meta name="robots" content="noindex" /></Helmet>
            ...
            <div className="card" style={{ marginBottom: '30px' }}>
              ...
              <form onSubmit={handleCourseSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '15px', marginTop: '15px' }}>
                ...
                <div style={{ gridColumn: '1 / -1', display: 'flex', gap: '10px' }}>
                  <button type="submit" className="btn btn-primary">{isEditingCourse ? 'Update Course' : 'Add Course'}</button>
                  {isEditingCourse && <button type="button" className="btn btn-outline" onClick={() => { setIsEditingCourse(false); setCourseForm({ id: '', title: '', image: '', price: '', duration: '', description: '', status: 'Active' }); }}>Cancel</button>}
                </div>
              </form>
            </div>
