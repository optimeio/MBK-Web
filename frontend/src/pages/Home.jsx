...
function Home() {
  ...
  return (
    <main>
      <Helmet>
        <title>MBK Technology | #1 Engineering & IT Training Institute in Salem</title>
        <meta name="description" content="MBK Technology is Salem's leading engineering and IT training institute. We deliver Industry 4.0, EV technology, AI, Smart Infrastructure, Naan Mudhalvan, and Corporate Skill Development programs in Tamil Nadu." />
        <link rel="canonical" href="https://mbktechnologies.info/" />
      ...
      <header className="hero">
        ...
        <div className="container hero-content">
          ...
          <div className="hero-btns">
            <a href="https://wa.me/918807653965" className="btn btn-primary" target="_blank" rel="noopener noreferrer"><Icon name="message-circle" style={{ width: '18px', height: '18px' }} /> Admissions &amp; Partnerships</a>
            <a href="#courses" className="btn btn-outline" onClick={(e) => { e.preventDefault(); document.getElementById('courses')?.scrollIntoView({ behavior: 'smooth' }); }}><Icon name="graduation-cap" style={{ width: '18px', height: '18px' }} /> Explore Programs</a>
          </div>
      ...
      <div style={{ borderTop: '1px solid var(--border)' }}>
        <Services id="services" hideHero={true} />
        <About id="about" hideHero={true} />
        <Contact id="contact" hideHero={true} />
      </div>
